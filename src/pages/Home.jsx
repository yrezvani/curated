    ...
    <div className="home-container">
        ...
        <div className="px-4 mx-auto max-w-screen-xl text-center py-24 lg:py-56">
            ...
            <div className="flex flex-col space-y-4 sm:flex-row sm:justify-center sm:space-y-0">
                <a href="#" className="inline-flex justify-center hover:text-gray-900 items-center py-1 px-5 sm:ms-4 text-base font-sans font-thin text-center text-white rounded-lg border border-white hover:bg-gray-100 focus:ring-4 focus:ring-gray-400 mt-2" onClick={routeChange}>
                    Explore
                </a>  
            </div>
        </div>
