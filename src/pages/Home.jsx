  ...
  return (
    <div className="home-container">
        ...
        <div className="px-4 mx-auto max-w-screen-xl text-center py-24 lg:py-56">
            ...
            <p className="mb-8 text-lg font-normal text-gray-300 lg:text-xl sm:px-16 lg:px-48"><span>Welcome to Curated!
Curated is an art gallery geared towards creating a visual symphony of artwork, paintings, and various artifact from all ages. We aim to take you on an artistic journey to inspire your artistic oasis and engage you on a visual symphony.</span></p>
